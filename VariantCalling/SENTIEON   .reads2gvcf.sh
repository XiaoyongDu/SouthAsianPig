...
release_dir=/home/xydu/00.soft/sentieon/sentieon/sentieon-genomics-201711  # 这里改成软件所在路径，该路径下有软件的bin文件夹
export SENTIEON_LICENSE=/home/xydu/00.soft/sentieon/sentieon/Huazhong_Agricultural_University_Yang_QY_Lab_cluster_eval_2.lic #这里写license的文件路径
